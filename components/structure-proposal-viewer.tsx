...
export function ProposalViewer({
    ...
    return (
        <Card className="w-full max-w-4xl mx-auto border-black/10 shadow-none rounded-none">
            <CardHeader>
                <CardTitle>Legal Proposal</CardTitle>
                <CardDescription>
                    I&apos;ve prepared a lawsuit outline proposal based on your case details. Feel free to review and modify any sections or claims to better align with your legal strategy. We can refine the structure as needed to ensure it accurately represents your case before proceeding with drafting the lawsuit.
                </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardFooter className="flex justify-between">
                ...
                <Button
                    ...
                    className="bg-[#934c1a] text-white hover:bg-[#68330d]"
